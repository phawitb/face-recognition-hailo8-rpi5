...
PATH = "/home/pi/Desktop/face-recognition-hailo8-rpi5"  # edit here -----------------------------------
...
# Create the pipeline ------------------------------------------------------------------
if SOURCE == 'file':
    source_element = f"filesrc location={PATH}/resources/face_recognition.mp4 name=src_0 ! decodebin"
elif SOURCE == 'usbcam':
